...
# Test 1: Aarnet
Write-Host "Aarnet - 4" -ForegroundColor Cyan
java -Xmx16G -cp $RCP edu.repetita.main.Main `
    ...
    > results\Aarnet_4.txt
Write-Host "Done" -ForegroundColor Green
Write-Host ""

# Test 2: BtEurope
Write-Host "BtEurope - 4" -ForegroundColor Cyan
java -Xmx16G -cp $RCP edu.repetita.main.Main `
    ...
    -perturbationPercent 0.5 `
    > results\BtEurope_4.txt
Write-Host "Done" -ForegroundColor Green
Write-Host ""

# Test 3: Geant2012
Write-Host "Geant2012 - 4" -ForegroundColor Cyan
java -Xmx16G -cp $RCP edu.repetita.main.Main `
...
Write-Host "Garr201201 - 4" -ForegroundColor Cyan
java -Xmx16G -cp $RCP edu.repetita.main.Main `
    -graph "$DATA\Garr201201.graph" `
    -demands "$DATA\Garr201201.0000.demands" `
    -numAdversarialMatrices 20 `
    ...
    -perturbationPercent 0.5 `
    > results\Garr201201_4.txt
Write-Host "Done" -ForegroundColor Green
Write-Host ""

# Test 5: Missouri
Write-Host "Missouri - 4" -ForegroundColor Cyan
java -Xmx16G -cp $RCP edu.repetita.main.Main `
    ...
    -perturbationPercent 0.5 `
    > results\Missouri_4.txt
Write-Host "Done" -ForegroundColor Green
Write-Host ""

# Test 6: Globenet
Write-Host "Globenet - 4" -ForegroundColor Cyan
java -Xmx16G -cp $RCP edu.repetita.main.Main `
    ...
    -maxPerturbedDemands 134 `
    -perturbationPercent 0.5 `
    > results\Globenet_4.txt
Write-Host "Done" -ForegroundColor Green
Write-Host ""

# Test 7 Esnet
Write-Host "Esnet - 4" -ForegroundColor Cyan
java -Xmx16G -cp $RCP edu.repetita.main.Main `
...
# Test 8: Uninett2011
Write-Host "Uninett2011 - 4" -ForegroundColor Cyan
java -Xmx16G -cp $RCP edu.repetita.main.Main `
